...
const customSortTest = (sortingAlgorithmName, inplace = true) => {
    ...
    it("Sorts in lexicographical order by default", () => {
        expect(sortedSortableCopy.length).toBe(sortedList.length);
        expect(sortedSortableCopy).toStrictEqual(sortedList);
        expect(sortedSortableCopy).not.toStrictEqual(unsortedList);
    });

    if (inplace) {
        it("Works inplace", () => {
            expect(sortedSortableCopy).toStrictEqual(sortedSortableReference);
        });
    }
    ...
    it(`Has .sortSteps (steps: ${sortableList.sortSteps})`, () => {
...
describe("SortableList", () => {
    ...
    describe("Sorting", () => {
        describe("Implementation of Array.sort() inplace", () => {
            ...
            it(`Has null .sortSteps (steps: ${sortableList.sortSteps})`, () => {
    ...
    describe("Custom sorting algorithms", () => {
        ...
        describe("Implementation of MergeSort", () => customSortTest("mergeSort", false));
